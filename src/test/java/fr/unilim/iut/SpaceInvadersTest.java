...
public class SpaceInvadersTest {
    ...
    public void test_MissilesBienTiresDepuisVaisseau () {
        ...
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(5, 2), new Position(5, 9), 2);
        ...
        spaceinvaders.recupererMissile().add((Missile) vaisseau.tirerUnMissile(new Dimension(3, 2), 2));
    ...
    public void test_EnvahisseurCorrectementPositionnerDansEspaceJeu() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(8,2), 1,1);
    ...
    @Test
    public void test_UneLigneEnvahisseurCorrectementPositionnerDansEspaceJeu() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(8,2), 2, 2);
    ...
    public void test_EnvahisseurAvance_SeDeplacerVersLaGauche() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(8,2),1,2);
    ...
    public void test_EnvahisseurImmobile_SeDeplacerVersLaGauche() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(0,2),1,1);
        spaceinvaders.deplacerEnvahisseurVersLaGauche();
        assertEquals("" +
                "...............\n" +
                "...............\n" +
    ...
    public void test_EnvahisseurImmobile_SeDeplacerVersLaDroite() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(13,2), 1,2);
        spaceinvaders.deplacerEnvahisseurVersLaDroite();
        assertEquals("" +
                "...............\n" +
                "...............\n" +
    ...
    public void test_EnvahisseurAvancePartiellement_SeDeplacerVersLaGauche() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(3,2),4,1);
        spaceinvaders.deplacerEnvahisseurVersLaGauche();
        assertEquals("" +
                "...............\n" +
                "...............\n" +
    ...
    public void test_EnvahisseurAvancePartiellement_SeDeplacerVersLaDroite() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9),1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(10,2),4,2);
        spaceinvaders.deplacerEnvahisseurVersLaDroite();
        assertEquals("" +
                "...............\n" +
                "...............\n" +
    ...
    public void test_UnNouveauEnvahisseurPositionneHorsEspaceJeu_DoitLeverExceptionHorsEspaceJeu() {
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(-1,2),1,2);
            fail("L'envahisseur est positionné trop à gauche : doit lever HorsEspaceJeuException");
        } catch (final HorsEspaceJeuException e) {

        }
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(16,2),1,2);
            fail("L'envahisseur est positionné trop à droit : doit lever HorsEspaceJeuException");
        } catch (final HorsEspaceJeuException e) {

        }
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(8,-1),1,2);
            fail("L'envahisseur est positionné trop en haut : doit lever HorsEspaceJeuException");
        } catch (final HorsEspaceJeuException e) {

        }
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,1), new Position(8,13),1,4);
    ...
    public void test_UnNouveauEnvahisseurPositionneDansEspaceJeuAvecUneDimensionTropGrande_DoitLeverExceptionDebordementEspaceJeu() {
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(3, 1), new Position(13, 2), 1,2);
            fail("L'envahisseur déborde de l'espace jeu vers la droite à cause de sa longueur");
        } catch (final DebordementEspaceJeuException e) {

        }
        try {
            spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(1,3), new Position(8,1),1,2);
    ...
    public void test_MissileToucheSprite_DoitDeclencherFinDuJeu() {
        spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7,2), new Position(5,9), 1);
        spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Dimension(4,3), new Position(5,4), 1,2);
